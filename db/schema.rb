...
ActiveRecord::Schema[8.0].define(version: 2025_05_12_182051) do
  ...
  create_table "identity_profiles", force: :cascade do |t|
    t.string "name"
    t.string "avatar_url"
    t.string "username"
    t.string "uri"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["identity_id"], name: "index_identity_profiles_on_identity_id"
  end
  ...
  add_foreign_key "identity_profiles", "identities"
end
